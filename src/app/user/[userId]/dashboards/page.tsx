  ...
  useEffect(() => {
    const fetchDashboards = async () => {
      ...
      try {
        ...
        try {
          const userResponse = await fetch(`https://localhost:8443/api/users/${routeUserId}`);
          if (userResponse.ok) {
        ...
        // Fetch dashboards
        const response = await fetch(`https://localhost:8443/api/users/${routeUserId}/dashboards`);
